...
public class ProcedureThethirdcrusade1189buttonpressed extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureThethirdcrusade1189buttonpressed(ElementsMinecrownrebornMod instance) {
		super(instance, 154);
	}
