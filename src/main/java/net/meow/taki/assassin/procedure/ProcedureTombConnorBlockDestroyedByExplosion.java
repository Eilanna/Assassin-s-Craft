...
public class ProcedureTombConnorBlockDestroyedByExplosion extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureTombConnorBlockDestroyedByExplosion(ElementsMinecrownrebornMod instance) {
		super(instance, 78);
	}
