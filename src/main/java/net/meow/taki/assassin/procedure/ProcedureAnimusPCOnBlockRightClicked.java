...
public class ProcedureAnimusPCOnBlockRightClicked extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureAnimusPCOnBlockRightClicked(ElementsMinecrownrebornMod instance) {
		super(instance, 179);
	}
