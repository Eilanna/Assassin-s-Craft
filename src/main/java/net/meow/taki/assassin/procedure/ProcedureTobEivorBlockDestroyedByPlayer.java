...
public class ProcedureTobEivorBlockDestroyedByPlayer extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureTobEivorBlockDestroyedByPlayer(ElementsMinecrownrebornMod instance) {
		super(instance, 188);
	}
