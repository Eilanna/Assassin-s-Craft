...
public class ProcedureItaly1459PlayerLeavesDimension extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureItaly1459PlayerLeavesDimension(ElementsMinecrownrebornMod instance) {
		super(instance, 127);
	}
