...
public class ProcedurePhantomActBulletHitsPlayer extends ElementsMinecrownrebornMod.ModElement {
	public ProcedurePhantomActBulletHitsPlayer(ElementsMinecrownrebornMod instance) {
		super(instance, 172);
	}
