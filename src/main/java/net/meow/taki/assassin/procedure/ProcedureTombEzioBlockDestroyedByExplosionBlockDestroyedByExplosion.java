...
public class ProcedureTombEzioBlockDestroyedByExplosionBlockDestroyedByExplosion extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureTombEzioBlockDestroyedByExplosionBlockDestroyedByExplosion(ElementsMinecrownrebornMod instance) {
		super(instance, 76);
	}
