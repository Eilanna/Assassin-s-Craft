...
public class ProcedurePhantomActRangedItemUsed extends ElementsMinecrownrebornMod.ModElement {
	public ProcedurePhantomActRangedItemUsed(ElementsMinecrownrebornMod instance) {
		super(instance, 31);
	}
