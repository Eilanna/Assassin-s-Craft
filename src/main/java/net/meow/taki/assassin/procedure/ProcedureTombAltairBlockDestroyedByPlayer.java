...
public class ProcedureTombAltairBlockDestroyedByPlayer extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureTombAltairBlockDestroyedByPlayer(ElementsMinecrownrebornMod instance) {
		super(instance, 71);
	}
