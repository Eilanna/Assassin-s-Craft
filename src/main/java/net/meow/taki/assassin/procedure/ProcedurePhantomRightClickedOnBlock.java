...
public class ProcedurePhantomRightClickedOnBlock extends ElementsMinecrownrebornMod.ModElement {
	public ProcedurePhantomRightClickedOnBlock(ElementsMinecrownrebornMod instance) {
		super(instance, 50);
	}
