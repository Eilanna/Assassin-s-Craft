...
public class ProcedureTombEdwardBlockDestroyedByPlayer extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureTombEdwardBlockDestroyedByPlayer(ElementsMinecrownrebornMod instance) {
		super(instance, 79);
	}
