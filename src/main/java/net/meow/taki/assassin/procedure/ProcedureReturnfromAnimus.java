...
public class ProcedureReturnfromAnimus extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureReturnfromAnimus(ElementsMinecrownrebornMod instance) {
		super(instance, 135);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((entity.dimension) == 0)) {
			entity.setPositionAndUpdate((MinecrownrebornModVariables.WorldVariables.get(world).SpawnX),
					(MinecrownrebornModVariables.WorldVariables.get(world).SpawnY), (MinecrownrebornModVariables.WorldVariables.get(world).SpawnZ));
		}
	}
