...
public class ProcedureTombArnoBlockDestroyedByExplosion extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureTombArnoBlockDestroyedByExplosion(ElementsMinecrownrebornMod instance) {
		super(instance, 85);
	}
