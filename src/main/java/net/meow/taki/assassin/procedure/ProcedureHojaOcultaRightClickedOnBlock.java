...
public class ProcedureHojaOcultaRightClickedOnBlock extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureHojaOcultaRightClickedOnBlock(ElementsMinecrownrebornMod instance) {
		super(instance, 52);
	}
