...
public class ProcedureTombEzioBlockDestroyedByExplosion extends ElementsMinecrownrebornMod.ModElement {
	public ProcedureTombEzioBlockDestroyedByExplosion(ElementsMinecrownrebornMod instance) {
		super(instance, 74);
	}
