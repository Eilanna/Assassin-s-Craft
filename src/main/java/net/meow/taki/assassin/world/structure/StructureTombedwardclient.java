...
public class StructureTombedwardclient extends ElementsMinecrownrebornMod.ModElement {
	public StructureTombedwardclient(ElementsMinecrownrebornMod instance) {
		super(instance, 95);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2750) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("minecrownreborn", "edward_tomb"));
				if (template == null)
					return;
