...
package net.meow.taki.assassin.world;
...
import net.meow.taki.assassin.procedure.ProcedureThrthirdcrusade1191PlayerLeavesDimensionPlayerLeavesDimension;
import net.meow.taki.assassin.procedure.ProcedureThethirdcrusade1189PlayerEntersDimension;
...
public class WorldThethirdcrusade1189 extends ElementsMinecrownrebornMod.ModElement {
	public static int DIMID = 9;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldThethirdcrusade1189(ElementsMinecrownrebornMod instance) {
		super(instance, 153);
	}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("minecrownreborn:syrianlands")),
				Biome.REGISTRY.getObject(new ResourceLocation("minecrownreborn:syrianplains")),
