...
public class StructureEstructuraprueba extends ElementsMinecrownrebornMod.ModElement {
	public StructureEstructuraprueba(ElementsMinecrownrebornMod instance) {
		super(instance, 90);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2750) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("minecrownreborn", "altair_tomb"));
				if (template == null)
					return;
