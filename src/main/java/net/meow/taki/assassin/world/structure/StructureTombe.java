...
public class StructureTombe extends ElementsMinecrownrebornMod.ModElement {
	public StructureTombe(ElementsMinecrownrebornMod instance) {
		super(instance, 91);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2750) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("minecrownreborn", "ezio_tomb"));
				if (template == null)
					return;
