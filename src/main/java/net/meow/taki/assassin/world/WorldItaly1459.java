...
import net.meow.taki.assassin.procedure.ProcedureItaly1459PlayerLeavesDimension;
import net.meow.taki.assassin.procedure.ProcedureItaly1459PlayerEntersDimension;
...
public class WorldItaly1459 extends ElementsMinecrownrebornMod.ModElement {
	public static int DIMID = 8;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldItaly1459(ElementsMinecrownrebornMod instance) {
		super(instance, 126);
	}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("minecrownreborn:italianplains")),};
