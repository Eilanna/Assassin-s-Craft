...
public class StructureEivortomb extends ElementsMinecrownrebornMod.ModElement {
	public StructureEivortomb(ElementsMinecrownrebornMod instance) {
		super(instance, 190);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2750) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("minecrownreborn", "eivor_tomb"));
				if (template == null)
					return;
