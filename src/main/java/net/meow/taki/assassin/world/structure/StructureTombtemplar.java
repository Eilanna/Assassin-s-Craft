...
public class StructureTombtemplar extends ElementsMinecrownrebornMod.ModElement {
	public StructureTombtemplar(ElementsMinecrownrebornMod instance) {
		super(instance, 96);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2250) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("minecrownreborn", "templar_tomb"));
				if (template == null)
					return;
