...
import net.meow.taki.assassin.procedure.ProcedureClose_Guantlet;
...
public class KeyBindingClose_gauntlet_key extends ElementsMinecrownrebornMod.ModElement {
	private KeyBinding keys;
	public KeyBindingClose_gauntlet_key(ElementsMinecrownrebornMod instance) {
		super(instance, 176);
	}
