...
package net.meow.taki.assassin.keybind;
...
import net.meow.taki.assassin.procedure.ProcedureEagleVisionhabilityOnKeyPressed;
...
public class KeyBindingEagleVisionhability extends ElementsMinecrownrebornMod.ModElement {
	private KeyBinding keys;
	public KeyBindingEagleVisionhability(ElementsMinecrownrebornMod instance) {
		super(instance, 106);
	}
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				MinecrownrebornMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
