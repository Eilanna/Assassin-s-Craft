...
import net.meow.taki.assassin.procedure.ProcedureTombArnoBlockDestroyedByPlayer;
import net.meow.taki.assassin.procedure.ProcedureTombArnoBlockDestroyedByExplosion;
...
public class BlockTombArno extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:tombarno")
	public static final Block block = null;
	public BlockTombArno(ElementsMinecrownrebornMod instance) {
		super(instance, 83);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrownreborn:tombarno", "inventory"));
	}
