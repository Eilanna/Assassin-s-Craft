...
import net.meow.taki.assassin.procedure.ProcedureAssassinGauntletRightClickedOnBlock;
...
public class ItemAssassinGauntlet extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:assassingauntlet")
	public static final Item block = null;
	public ItemAssassinGauntlet(ElementsMinecrownrebornMod instance) {
		super(instance, 53);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrownreborn:assassingauntlet", "inventory"));
	}
