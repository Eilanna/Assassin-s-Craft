...
public class ItemAltairsword extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:altairsword")
	public static final Item block = null;
	public ItemAltairsword(ElementsMinecrownrebornMod instance) {
		super(instance, 167);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrownreborn:altairsword", "inventory"));
	}
}
