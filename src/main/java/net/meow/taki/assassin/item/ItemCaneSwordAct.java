...
import net.meow.taki.assassin.procedure.ProcedureCaneSwordActRightClickedOnBlock;
...
public class ItemCaneSwordAct extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:caneswordact")
	public static final Item block = null;
	public ItemCaneSwordAct(ElementsMinecrownrebornMod instance) {
		super(instance, 44);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrownreborn:caneswordact", "inventory"));
	}
}
