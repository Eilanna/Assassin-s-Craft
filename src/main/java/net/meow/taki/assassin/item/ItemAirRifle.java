...
import net.meow.taki.assassin.procedure.ProcedureAirRifleRangedItemUsed;
...
public class ItemAirRifle extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:airrifle")
	public static final Item block = null;
	public static final int ENTITYID = 7;
	public ItemAirRifle(ElementsMinecrownrebornMod instance) {
		super(instance, 68);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("minecrownreborn", "entitybulletairrifle"), ENTITYID).name("entitybulletairrifle").tracker(64, 1, true)
				.build());
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrownreborn:airrifle", "inventory"));
	}
