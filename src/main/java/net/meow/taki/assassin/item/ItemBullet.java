...
public class ItemBullet extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:bullet")
	public static final Item block = null;
	public ItemBullet(ElementsMinecrownrebornMod instance) {
		super(instance, 5);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrownreborn:bullet", "inventory"));
	}
