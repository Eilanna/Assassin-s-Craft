...
public class ItemLongsword extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:longsword")
	public static final Item block = null;
	public ItemLongsword(ElementsMinecrownrebornMod instance) {
		super(instance, 170);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrownreborn:longsword", "inventory"));
	}
}
