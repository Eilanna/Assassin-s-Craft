...
import net.meow.taki.assassin.procedure.ProcedurePhantomRightClickedOnBlock;
...
public class ItemPhantom extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:phantom")
	public static final Item block = null;
	public ItemPhantom(ElementsMinecrownrebornMod instance) {
		super(instance, 27);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrownreborn:phantom", "inventory"));
	}
