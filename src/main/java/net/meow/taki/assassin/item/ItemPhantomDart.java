...
public class ItemPhantomDart extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:phantomdart")
	public static final Item block = null;
	public ItemPhantomDart(ElementsMinecrownrebornMod instance) {
		super(instance, 29);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrownreborn:phantomdart", "inventory"));
	}
