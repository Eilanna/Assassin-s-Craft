...
import net.meow.taki.assassin.procedure.ProcedureHojaOcultaActRightClickedOnBlock;
...
public class ItemHoja_OcultaAct extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:hoja_ocultaact")
	public static final Item block = null;
	public ItemHoja_OcultaAct(ElementsMinecrownrebornMod instance) {
		super(instance, 7);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrownreborn:hoja_ocultaact", "inventory"));
	}
