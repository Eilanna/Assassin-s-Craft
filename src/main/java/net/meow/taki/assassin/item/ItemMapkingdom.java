...
import net.meow.taki.assassin.procedure.ProcedureKigndomRightClickedOnBlock;
...
public class ItemMapkingdom extends ElementsMinecrownrebornMod.ModElement {
	@GameRegistry.ObjectHolder("minecrownreborn:mapkingdom")
	public static final Item block = null;
	public ItemMapkingdom(ElementsMinecrownrebornMod instance) {
		super(instance, 193);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrownreborn:mapkingdom", "inventory"));
	}
