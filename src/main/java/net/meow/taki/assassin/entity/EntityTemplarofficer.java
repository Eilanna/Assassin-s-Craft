...
public class EntityTemplarofficer extends ElementsMinecrownrebornMod.ModElement {
	public static final int ENTITYID = 18;
	public static final int ENTITYID_RANGED = 19;
	public EntityTemplarofficer(ElementsMinecrownrebornMod instance) {
		super(instance, 164);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("minecrownreborn", "templarofficer"), ENTITYID)
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("minecrownreborn:textures/templar_officer.png");
				}
			};
