...
package net.meow.taki.assassin.entity;
...
import net.meow.taki.assassin.item.ItemLongsword;
import net.meow.taki.assassin.ElementsMinecrownrebornMod;

@ElementsMinecrownrebornMod.ModElement.Tag
public class EntityTemplarKnight extends ElementsMinecrownrebornMod.ModElement {
	public static final int ENTITYID = 22;
	public static final int ENTITYID_RANGED = 23;
	public EntityTemplarKnight(ElementsMinecrownrebornMod instance) {
		super(instance, 171);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("minecrownreborn", "templarknight"), ENTITYID)
						.name("templarknight").tracker(7, 3, true).egg(-10092544, -1).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("minecrownreborn:syrianplains")),
				Biome.REGISTRY.getObject(new ResourceLocation("minecrownreborn:syriandunes")),
				Biome.REGISTRY.getObject(new ResourceLocation("minecrownreborn:syrianlands")),};
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("minecrownreborn:textures/caballero_templario.png");
				}
			};
