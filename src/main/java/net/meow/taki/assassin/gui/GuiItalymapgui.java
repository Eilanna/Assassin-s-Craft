...
import net.meow.taki.assassin.procedure.ProcedureReturnfromItaly;
...
public class GuiItalymapgui extends ElementsMinecrownrebornMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiItalymapgui(ElementsMinecrownrebornMod instance) {
		super(instance, 140);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("minecrownreborn:textures/italymapgui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("minecrownreborn:textures/descarga.png"));
