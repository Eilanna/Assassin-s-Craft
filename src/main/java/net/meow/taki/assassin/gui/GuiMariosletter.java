...
public class GuiMariosletter extends ElementsMinecrownrebornMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiMariosletter(ElementsMinecrownrebornMod instance) {
		super(instance, 142);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("minecrownreborn:textures/mariosletter.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("minecrownreborn:textures/map (4).png"));
